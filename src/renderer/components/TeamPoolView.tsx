                        ...
                        return (
                          <div key={side} className={side === 'B' ? 'text-right' : ''}>
                            <div className="text-gray-500 mb-1">
                              {t('team.team_card_e_heading')} — {team?.name ?? '—'}
                            </div>
                            <div
                            ...
                            >
                              {TEAM_CARD_TYPES.map(type => (
                                <button
                                  ...
                                  title={`${t('team.card_label')} ${type} E${type === suggested ? t('team.suggested_suffix') : ''}`}
